...
function playList(){
	...
	this.play = function(){
		...
		document.getElementById("player-play").setAttribute("class","player-control glyphicon glyphicon-pause");
	...
	this.pause=function(){
		...
		// Cambiar icono
		document.getElementById("player-play").setAttribute("class","");
		document.getElementById("player-play").setAttribute("class","player-control glyphicon glyphicon-play");	
	}
	...
	this.changeInfoSong = function(){
		...
		$("#album-cover-play").attr("src",imgURL);
	}
	this.stop = function(){
		soundManager.stopAll();
		// Cambiar icono
